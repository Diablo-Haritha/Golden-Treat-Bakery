...
<head>
  ...
  <style>
    ...
    :root {
      ...
      --light: #FFF8F0;
      --white: #FFFFFF;
      --gradient-1: linear-gradient(135deg, #0e0e0dff, #FFE5B4);
      --gradient-2: linear-gradient(135deg, #0f06004d, #11100fff);
...
<body>
  ...
  <nav>
    <ul>
      ...
      <li><a href="./product/index.php">Admin Product</a></li>
  ...
  <div class="quick-actions">
    <div class="quick-btn" title="Login">Shop</div>
  ...
  <div class="loginbtn" id="floatingCart">
    <a href="../bakehouse/index.html" class="myButton">Management</a>
  ...
  <section class="hero" id="home">
    ...
    <div class="hero-content">
      <h1>
        <span class="word word--golden">Admin</span>
        <span class="welcome-message">Dashboad</span>
        <span class="word word--treat">Manager</span>
      </h1>
      <p>Artisan Bakery • Fresh Daily • Premium Quality</p>
      <div class="action-buttons">
        <a href="./product/admin.php" class="btn">Product Manage</a>
        <a href="../bakehouse/index.html" class="btn">Shop Management</a>
        <a href="./product/index.php" class="btn">View Store</a>
