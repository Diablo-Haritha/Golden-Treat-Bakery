...
<head>
    ...
    <style>
        ...
        * {
        ...
        .btn-warning {
            background: linear-gradient(135deg, var(--warning), #ffd760);
        }
...
<body>
    ...
    <img src="../Admin/product/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
<?php else: ?>
    <i class="fas fa-<?php 
