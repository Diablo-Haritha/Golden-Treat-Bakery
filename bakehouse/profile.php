...
<body>
        ...
        <div class="profile-card">
            ...
            <div class="profile-picture">
                ...
                <label for="profile-upload"><i class="fas fa-camera"></i> Change Photo
                    <input type="file" id="profile-upload" accept="image/jpeg,image/png,image/gif">
                </label>
            </div>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        document.querySelector('.welcome-banner').textContent = `Welcome Back, ${user.full_name || 'User'}!`;
                        ...
                        if (response.message.includes('not logged in') || response.message.includes('User not found')) {
                            setTimeout(() => window.location.href = 'login.php', 3000);
                        }
                    }
                },
                error: function(xhr, status, error) {
                    showMessage('Error fetching user data: ' + (xhr.responseJSON?.message || 'Unknown error'), true);
        ...
        document.getElementById('profile-form').addEventListener('submit', function(event) {
            ...
            if (!/^\+?\d{10,15}$/.test(profileData.mobile)) {
                showMessage('Invalid mobile number.', true);
                return;
            }
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    showMessage('Error updating profile: ' + (xhr.responseJSON?.message || 'Unknown error'), true);
        ...
        document.getElementById('profile-upload').addEventListener('change', function(event) {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    showMessage('Error uploading profile picture: ' + (xhr.responseJSON?.message || 'Unknown error'), true);
        ...
        function confirmLogout() {
            if (confirm('Are you sure you want to log out?')) {
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        showMessage('Error logging out: ' + (xhr.responseJSON?.message || 'Unknown error'), true);
        ...
        function confirmDeleteAccount() {
            if (confirm('Are you sure you want to delete your account? This action cannot be undone.')) {
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        showMessage('Error deleting account: ' + (xhr.responseJSON?.message || 'Unknown error'), true);
