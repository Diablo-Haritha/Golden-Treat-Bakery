  ...
  <div class="layout">
    ...
    <aside class="sidebar">
      ...
      <nav>
        ...
        <div class="salebtn">
          <button class="tab-btn active" onclick="window.location.href='salesdash.php'">Sales Dashboard</button>
          <button class="tab-btn" onclick="window.location.href='salesorg.php'">Sales SUM</button>
          <button class="tab-btn"onclick="window.location.href='salesorg.php'">Export Report</button>
