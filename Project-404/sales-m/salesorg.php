...
<body>
  ...
  <div class="layout">
    ...
    <aside class="sidebar">
      ...
      <nav>
        <button class="salesbtn"onclick="window.location.href='salesorg.php'">Sales</button>
        <div class="otherbtn">
        ...
        <div class="salebtn">
          <button class="tab-btn " onclick="window.location.href='salesdash.php'">Sales Dashboard</button>
          <button class="tab-btn active" onclick="window.location.href='salesorg.php'">Sales SUM</button>
          <button class="tab-btn"onclick="window.location.href='salesdash.php'">Export Report</button>
        </div>
      </nav>
    </aside>
