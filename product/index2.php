        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <a href="#products" class="btn btn-primary animated fadeIn">
                    <i class="fas fa-arrow-down"></i> Explore Our Treats
                </a>
            </div>
        </section>
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-column">
                    <h3>Contact Info</h3>
                    <ul>
                        <li><i class="fas fa-map-marker-alt"></i> 123 Bakery Street, Bakerville</li>
            ...
            <div class="copyright">
                &copy; 2024 Golden Treat Bakery. All rights reserved. | Made with <i class="fas fa-heart" style="color: var(--danger);"></i>
            </div>
        </div>
    </footer>
